...
public class Main {
    ...
    public static void FindByFilter(Set<Notebooks> products, String filter, String input) {
        int count = 1;
    ...
    public static void main(String[] args) {
        Notebooks PC1 = new Notebooks("1", "HP 250", "Intel Core i5", "4 GB", "2T", "Black");
        Notebooks PC2 = new Notebooks("2", "ASUS Vivobook Go 14", "Intel Pentium Silver N6000", "4 GB", "1T", "Grey");
        Notebooks PC3 = new Notebooks("3", "Lenovo IdeaPad 1", "AMD Athlon Silver 3050e", "4 GB", "2T", "Black");
        Notebooks PC4 = new Notebooks("4", "Lenovo IdeaPad 1", "AMD Athlon Silver 3050e", "8 GB", "2T", "White");
        Notebooks PC5 = new Notebooks("5", "HP 250", "Intel Core i5", "4 GB", "1T", "Grey");
        Notebooks PC6 = new Notebooks("5", "HP 250", "Intel Core i5", "8 GB", "2T", "White");
